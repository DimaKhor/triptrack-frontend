                ...
                <ul className="main__about__cards">
                    <li>
                        <div>
                            ...
                            <p className="main__card-text">Add multiple stops, edit your route, and get turn-by-turn directions.</p>
                        </div>
                    </li>
                    <li>
                        <div>
                    ...
                    <li>
                        <div>
                            <img src={card3}  className="main__card-img"/>
                            <h4 className="main__card-title">Поделись воспоминаниями</h4>
                            <p className="main__card-text">Find and book a hotel, vacation rental, or other accommodations.</p>
                        </div>
                    </li>
                    <li>
                        <div>
                            <img src={card4}  className="main__card-img"/>
